...
class HelpDetailUi extends GetView<HelpController> {
  HelpDetailUi({Key? key}) : super(key: key);
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Image.asset(
                      controller.detail[index]["img"],
                    ),
                    SizedBox(
                      height: 80.h,
                    ),
                    Text(
                      controller.detail[index]["contentTitle"],
                      style: TextStyle(
                        color: const Color(0xFF333333),
                        fontSize: 50.sp,
                        fontFamily: 'Core_Gothic_D6',
                    ...
                    Text(
                      controller.detail[index]["content"],
                      style: TextStyle(
                        color: const Color(0xFF333333),
                        fontSize: 40.sp,
